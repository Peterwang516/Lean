...
namespace QuantConnect.Algorithm.Framework.Alphas
{
    ...
    public class Insight
    {
        ...
        public Insight(Symbol symbol, TimeSpan period, InsightType type, InsightDirection direction, double? magnitude, double? confidence, string sourceModel = null)
        {
            ...
            _periodSpecification = new PeriodSpecification(period);
        }
        ...
        {
            if (Period == default(TimeSpan) || CloseTimeUtc == default(DateTime))
            {
        ...
        {
            var spec = new PeriodSpecification(period);
            return new Insight(symbol, spec, InsightType.Price, direction, magnitude, confidence, sourceModel);
        }
        ...
        {
            var generatedTimeLocal = generatedTimeUtc.ConvertFromUtc(TimeZones.NewYork);
            var closeTimeLocal = closeTimeUtc.ConvertFromUtc(TimeZones.NewYork);
        ...
        /// </summary>
        private class PeriodSpecification : IPeriodSpecification
        {
            public readonly TimeSpan Period;

            public PeriodSpecification(TimeSpan period)
            {
